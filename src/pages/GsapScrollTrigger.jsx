...
const GsapScrollTrigger = () => {
  ...
  // Animation only occurs during a scroll
    ...
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          scrollTrigger: {
            trigger: box,
            start: "bottom bottom", // Triggers when bottoms of the box is seen
            end: "top 10%", // Animation ends around 20% of the vh
            scrub: true, // Allows it to reverse and speed matters on how fast you're scrolling
          },
          ease: "power1.inOut",
        });
      });
