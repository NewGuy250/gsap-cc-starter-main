...
const GsapFromTo = () => {
  ...
  // Fromto takes both the to and from attributes as arguments
  useGSAP(() => {
    gsap.fromTo(
      "#red-box",
      {
      ...
      {
        x: 250, // Move 250 pixels
        repeat: -1, // Repeat indefinitely
        yoyo: true, // Moves back and foward
        borderRadius: "100%", // Changes shape into circle
        rotation: 360, // Full rotation
        duration: 2, // Length
        ease: "bounce.out", // Type of physics
      }
    );
  });
